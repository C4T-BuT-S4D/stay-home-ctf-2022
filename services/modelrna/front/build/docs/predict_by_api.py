...
YOUR_DATA = {
    ...
    "age": 32,  # Your age
    "blood_type": 2,  # 0,1,2,3,
    "rh": 1,  # 1 - positive, -1 - negative
    "sugar_level": 1.337,  # your blood sugar level
    "ssn": "<your_ssn>"  # your ssn
}

VACCINE_ID = "<some_uuid>"

client = ApiClient(HOST, None)

response = client.send_prediction(VACCINE_ID, YOUR_DATA)
print(response)
